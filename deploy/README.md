...
Правила в `proxy/Caddyfile`: POST `/api/match` — 10/мин с IP (для всех,
включая ботов); страницы и GET — 120/мин с IP; поисковые боты
(Googlebot/YandexBot/… по User-Agent) страницы читают без лимитов.
Превышение — HTTP 429. UA спуфится — для пилота это осознанный компромисс.
